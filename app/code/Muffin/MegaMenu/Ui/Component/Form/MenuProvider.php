 ...
 * @api
 */
class MenuProvider implements DataProviderInterface
{
    ...
    {
        $list = $this->searchResultToOutput($this->getSearchResult());
        foreach ($list['items'] as &$item) {
            if ($item['menu_name'] == '' and $item['menu_url'] == '') {
                $item['menu_name'] = $this->categoryRepository->get($item['category_id'])->getName();
                $item['menu_url'] = $this->categoryRepository->get($item['category_id'])->getData('url_key');
            }
        }
        unset($item);
        return $list;
